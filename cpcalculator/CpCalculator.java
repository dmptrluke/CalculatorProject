...
public class CpCalculator extends javax.swing.JFrame {
   ...
   private void setDegrees() {
    ...
    private void btnDegreesItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_btnDegreesItemStateChanged
        if (extMode != "degrees") {
            setDegrees();
        }
    }//GEN-LAST:event_btnDegreesItemStateChanged

    private void btnRadiansItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_btnRadiansItemStateChanged
        if (extMode != "radians") {
            setRadians();
        }
    }//GEN-LAST:event_btnRadiansItemStateChanged
    ...
    private void btnDecimalPlaceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDecimalPlaceActionPerformed
        pressedNum(".");
    }//GEN-LAST:event_btnDecimalPlaceActionPerformed
    ...
    private void round4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_round4ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_round4ActionPerformed

    private void round1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_round1ItemStateChanged
        setRounding(1);
    }//GEN-LAST:event_round1ItemStateChanged

    private void round2ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_round2ItemStateChanged
        setRounding(2);
    }//GEN-LAST:event_round2ItemStateChanged

    private void round3ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_round3ItemStateChanged
        setRounding(3);
    }//GEN-LAST:event_round3ItemStateChanged

    private void round4ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_round4ItemStateChanged
        setRounding(4);
    }//GEN-LAST:event_round4ItemStateChanged

    private void round5ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_round5ItemStateChanged
        setRounding(5);
    }//GEN-LAST:event_round5ItemStateChanged

    private void round6ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_round6ItemStateChanged
        setRounding(6);
    }//GEN-LAST:event_round6ItemStateChanged

    private void round7ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_round7ItemStateChanged
        setRounding(7);
    }//GEN-LAST:event_round7ItemStateChanged

    private void round8ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_round8ItemStateChanged
        setRounding(8);
    }//GEN-LAST:event_round8ItemStateChanged

    private void round9ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_round9ItemStateChanged
        setRounding(9);       
    }//GEN-LAST:event_round9ItemStateChanged

    private void tglExtendItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_tglExtendItemStateChanged
    ...
    }//GEN-LAST:event_tglExtendItemStateChanged
